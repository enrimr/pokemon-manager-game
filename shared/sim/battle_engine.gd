...
## MatchEngine.tally override — parse one battle's event log into per-uid
## stats merged into `out` (persisted as fixture detail; moved verbatim from
## Season._tally_battle in theming phase 1, docs/THEMING.md).
func tally(events: Array, teams: Array, p_winner: int, out: Dictionary) -> void:

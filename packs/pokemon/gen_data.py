#!/usr/bin/env python3
"""Generates packs/pokemon/data/{pokemon,moves,typechart,world,items}.json for Trainer Manager.
Deterministic (seeded). Run from repo root: python3 tools/gen_data.py
"""
import json, os, random

# lives inside the pack now: output lands next to this script in data/
PACK = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(PACK, "data")
